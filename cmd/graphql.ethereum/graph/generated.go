...
func (ec *executionContext) field_Mutation_explainCampaign_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	args["isFake"] = arg14
	var arg15 int
	if tmp, ok := rawArgs["seedLiquidity"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("seedLiquidity"))
		arg15, err = ec.unmarshalNInt2int(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
	args["seedLiquidity"] = arg15
	return args, nil
}
