...
func (ec *executionContext) _Campaign(ctx context.Context, sel ast.SelectionSet, obj *types.Campaign) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "creator":
			out.Values[i] = ec._Campaign_creator(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "oracle":
			out.Values[i] = ec._Campaign_oracle(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "identifier":
			out.Values[i] = ec._Campaign_identifier(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "poolAddress":
			out.Values[i] = ec._Campaign_poolAddress(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "outcomes":
			out.Values[i] = ec._Campaign_outcomes(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) _Outcome(ctx context.Context, sel ast.SelectionSet, obj *types.Outcome) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "campaign":
			out.Values[i] = ec._Outcome_campaign(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "name":
		...
		case "creator":
			out.Values[i] = ec._Outcome_creator(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "identifier":
