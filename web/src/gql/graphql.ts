...
export type CampaignListQuery = { __typename?: 'Query', campaigns: Array<{ __typename?: 'Campaign', name: string, identifier: string, description: string, picture: string, oracle: string, poolAddress: string, ending: number, starting: number, creator: { __typename?: 'Wallet', address: string }, outcomes: Array<{ __typename?: 'Outcome', identifier: string, name: string, description: string, share: { __typename?: 'Share', address: string } }> }> };
