...
const useBuyDppmWithPaymaster = ({
  ...
  const buyDppmWithPaymaster = async (fusdc: number, referrer: string) =>
    toast.promise(
  ...
  return { buyDppmWithPaymaster };
};

export default useBuyDppmWithPaymaster;
