    ...
    <Section>
      ...
      <List
        items={[
          ...
          "Infrastructure Markets: Infrastructure Markets are a new natural oracle powered by ARB and Staked ARB that determines truth after a deadline through the process of voting and staking. To learn more, read Introduction to Infra Markets below.",
          "Opinion Polls: Opinion Polls are self resolving markets that are suitable for opinion polling. Markets are settled by the proportion of shares in the different outcomes.",
...
function Achievments() {
  return (
    <Section>
      ...
      />
      <Title text="Achievements Coming Soon.." />
      <Parag text="Connect your wallet, make predictions, share your insights, and get involved. There’s always an achievement waiting to be unlocked on 9Lives." />
    </Section>
  );
}
