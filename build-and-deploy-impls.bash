...
trading_mint_impl="$(./deploy-stylus.sh contract-trading-dpm-trading-mint.wasm)"
[ "$trading_mint_impl" = "${SPN_TRADING_MINT_IMPL_ADDR,,}" ] || err "trading mint differs"
>&2 echo "SPN_TRADING_MINT_IMPL_ADDR='$trading_mint_impl'"
trading_extras_impl="$(./deploy-stylus.sh contract-trading-dpm-trading-extras.wasm)"
