...
deploy_hash="$(forge create --json \
	...
	--constructor-args \
	"($SPN_PROXY_ADMIN,$SPN_EMERGENCY_COUNCIL,$SPN_SHARE_IMPL_ADDR,$SPN_FACTORY_1_IMPL_ADDR,$SPN_FACTORY_2_IMPL_ADDR,$SPN_TRADING_DPPM_EXTRAS_IMPL_ADDR,$SPN_TRADING_DPPM_MINT_IMPL_ADDR,$SPN_TRADING_DPPM_QUOTES_IMPL_ADDR,$SPN_TRADING_DPPM_PRICE_IMPL_ADDR,$SPN_TRADING_AMM_EXTRAS_IMPL_ADDR,$SPN_TRADING_AMM_MINT_IMPL_ADDR,$SPN_TRADING_AMM_QUOTES_IMPL_ADDR,$SPN_TRADING_AMM_PRICE_IMPL_ADDR,$SPN_BEAUTY_CONTEST_IMPL_ADDR)" \
