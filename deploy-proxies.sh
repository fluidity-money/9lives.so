...
deploy_hash="$(forge create --json \
	...
	--constructor-args \
	"($SPN_PROXY_ADMIN, $SPN_EMERGENCY_COUNCIL, $SPN_LOCKUP_TOKEN_IMPL_ADDR, $SPN_SHARE_IMPL_ADDR, $SPN_FACTORY_1_IMPL_ADDR, $SPN_FACTORY_2_IMPL_ADDR, $SPN_INFRA_MARKET_PREDICT_IMPL_ADDR, $SPN_INFRA_MARKET_SWEEP_IMPL_ADDR, $SPN_INFRA_MARKET_EXTRAS_IMPL_ADDR, $SPN_LOCKUP_IMPL_ADDR, $SPN_TRADING_DPM_EXTRAS_IMPL_ADDR, $SPN_TRADING_DPM_MINT_IMPL_ADDR, $SPN_TRADING_DPM_QUOTES_IMPL_ADDR, $SPN_TRADING_DPM_PRICE_IMPL_ADDR, $SPN_TRADING_AMM_EXTRAS_IMPL_ADDR, $SPN_TRADING_AMM_MINT_IMPL_ADDR, $SPN_TRADING_AMM_QUOTES_IMPL_ADDR, $SPN_TRADING_AMM_PRICE_IMPL_ADDR)" \
