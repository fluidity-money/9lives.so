...
cast send \
	...
	"$SPN_TRADING_DPPM_EXTRAS" \
	"$SPN_TRADING_DPPM_MINT" \
	"$SPN_TRADING_DPPM_QUOTES" \
	"$SPN_TRADING_DPPM_PRICE" \
	"$SPN_TRADING_AMM_EXTRAS" \
	"$SPN_TRADING_AMM_MINT" \
